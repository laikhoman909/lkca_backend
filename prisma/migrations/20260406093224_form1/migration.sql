...
-- CreateTable
CREATE TABLE "_Form1LatarBelakangPribadi" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_Form1LatarBelakangPribadi_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_Form1LatarBelakangBu" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_Form1LatarBelakangBu_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "key_value_group_label_CustomValue_key" ON "key_value"("group", "label", "CustomValue");

-- CreateIndex
CREATE INDEX "key_list_form0Id_form2Id_idx" ON "key_list"("form0Id", "form2Id");

-- CreateIndex
CREATE INDEX "form1_susunan_pengurus_form1Id_idx" ON "form1_susunan_pengurus"("form1Id");

-- CreateIndex
CREATE INDEX "_Form1LatarBelakangPribadi_B_index" ON "_Form1LatarBelakangPribadi"("B");

-- CreateIndex
CREATE INDEX "_Form1LatarBelakangBu_B_index" ON "_Form1LatarBelakangBu"("B");
...
-- AddForeignKey
ALTER TABLE "key_list" ADD CONSTRAINT "key_list_form2Id_fkey" FOREIGN KEY ("form2Id") REFERENCES "form2"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "dokumen_persyaratan" ADD CONSTRAINT "dokumen_persyaratan_form2Id_fkey" FOREIGN KEY ("form2Id") REFERENCES "form2"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Form1LatarBelakangPribadi" ADD CONSTRAINT "_Form1LatarBelakangPribadi_A_fkey" FOREIGN KEY ("A") REFERENCES "form1"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Form1LatarBelakangPribadi" ADD CONSTRAINT "_Form1LatarBelakangPribadi_B_fkey" FOREIGN KEY ("B") REFERENCES "key_value"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Form1LatarBelakangBu" ADD CONSTRAINT "_Form1LatarBelakangBu_A_fkey" FOREIGN KEY ("A") REFERENCES "form1"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Form1LatarBelakangBu" ADD CONSTRAINT "_Form1LatarBelakangBu_B_fkey" FOREIGN KEY ("B") REFERENCES "key_value"("id") ON DELETE CASCADE ON UPDATE CASCADE;
